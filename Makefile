...
main:	${OBJ_DIR}/main.o ${OBJ_DIR}/snake.o ${OBJ_DIR}/reversi.o ${OBJ_DIR}/lig4.o ${OBJ_DIR}/game_center.o ${OBJ_DIR}/player_repository.o ${OBJ_DIR}/player.o ${OBJ_DIR}/game_ids.o
