...
${OBJ_DIR}/game.o: ${INCLUDE_DIR}/game.h
...
main: ${OBJ_DIR}/main.o ${OBJ_DIR}/player.o ${OBJ_DIR}/players_repository.o ${OBJ_DIR}/games/reversi.o ${OBJ_DIR}/games/lig4.o ${OBJ_DIR}/game.o
	${CC} ${FLAGS} ${OBJ_DIR}/main.o ${OBJ_DIR}/player.o ${OBJ_DIR}/players_repository.o ${OBJ_DIR}/game.o ${OBJ_DIR}/games/reversi.o ${OBJ_DIR}/games/lig4.o -o game
